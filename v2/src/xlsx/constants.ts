...
/**
 * Name of the hidden BOM clone-template sheet.  Only present in
 * macro-enabled workbooks (see `GenerateOptions.vbaTemplate`); the VBA
 * `AddTab` macro clones it to create new Components tabs.
 */
export const TEMPLATE_SHEET_NAME = '_BOMTemplate';

/** Number of empty data rows pre-generated in the template sheet. */
export const TEMPLATE_DATA_ROWS = 12;

/**
 * Group header (section) row for the template sheet: a title + group
 * label, with the closing total footer generated by genBOMSheet.
 */
export const TEMPLATE_SECTION_QTY = 'gen';
export const TEMPLATE_SECTION_FUNCTION = 'General';
